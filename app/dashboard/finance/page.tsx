  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-black border border-zinc-900/50 shadow-xl hover:shadow-2xl transition-shadow duration-200 rounded-lg p-4 sm:p-6">
          <p className="text-sm text-zinc-500">Balance Neto</p>
          <div className="flex items-baseline gap-2 mt-2">
        ...
        <div className="bg-black border border-zinc-900/50 shadow-xl hover:shadow-2xl transition-shadow duration-200 rounded-lg p-4 sm:p-6">
          <p className="text-sm text-zinc-500">Rendimiento</p>
          <div className="flex items-baseline gap-2 mt-2">
      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-2">
        ...
        <div className="bg-black border border-zinc-900/50 shadow-xl hover:shadow-2xl transition-shadow duration-200 rounded-lg p-4 sm:p-6">
          ...
          <p className="text-sm text-zinc-500 mt-1">Ingresos, gastos y balance en los últimos 6 meses</p>
          ...
          <div className="mt-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              <p className="text-sm text-zinc-500">Tendencia positiva del 12.5% este semestre</p>
        ...
        <div className="bg-black border border-zinc-900/50 shadow-xl hover:shadow-2xl transition-shadow duration-200 rounded-lg p-4 sm:p-6">
          ...
          <p className="text-sm text-zinc-500 mt-1">Desglose por categorías</p>
          ...
          <div className="mt-4 pt-4 border-t border-zinc-900/50">
            <div className="flex justify-between items-center">
              <p className="text-sm text-zinc-500">Total gastos: 22.300,00 €</p>
